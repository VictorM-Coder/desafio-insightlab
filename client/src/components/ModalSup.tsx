...
import {Button, Col, Form, FormProps, Input, InputNumber, Modal, Row} from "antd";
...
const ModalSup = forwardRef(({ title, supplier }: Props, ref) => {
    ...
    return (
        <Modal width="800px" style={{ top: 20 }} title={title} open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
            <Form
                name="basic"
                labelCol={{ span: 24 }}
                wrapperCol={{ span: 24 }}
